...
attribute vec2 a_squareShapeTextureMap;
attribute vec2 a_squareIconTextureMap;
...
void main() {
  // gl_Position = u_matrix * vec4(a_pinLoc.xy, 0.0, 1.0);
  ...
  v_iconShapeCoord = a_squareShapeTextureMap;
  v_iconCoord = a_squareIconTextureMap;
}`;
